...
( NAME = N'data', FILENAME = N'E:\MSSQL12.SQLDEV1\MSSQL\DATA\DW_Staging_data.mdf' , SIZE = 178488320KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10240KB ), 
 FILEGROUP [index] 
( NAME = N'index', FILENAME = N'E:\MSSQL12.SQLDEV1\MSSQL\DATA\DW_Staging_index.mdf' , SIZE = 235520000KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10240KB )
 LOG ON 
( NAME = N'DW_Staging_log', FILENAME = N'E:\MSSQL12.SQLDEV1\MSSQL\DATA\DW_Staging_log.ldf' , SIZE = 41984KB , MAXSIZE = 2048GB , FILEGROWTH = 10240KB )
GO
