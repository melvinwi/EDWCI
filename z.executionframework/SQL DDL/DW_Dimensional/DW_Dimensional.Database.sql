...
( NAME = N'data', FILENAME = N'E:\MSSQL12.SQLDEV1\MSSQL\DATA\DW_Dimensional_data.mdf' , SIZE = 18908160KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10240KB ), 
 FILEGROUP [index] 
( NAME = N'index', FILENAME = N'E:\MSSQL12.SQLDEV1\MSSQL\DATA\DW_Dimensional_index.mdf' , SIZE = 18037760KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10240KB )
 LOG ON 
( NAME = N'DW_Dimensional_log', FILENAME = N'E:\MSSQL12.SQLDEV1\MSSQL\DATA\DW_Dimensional_log.ldf' , SIZE = 17906688KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
