...
--/
	...
	INSERT INTO temp.FactActivity (
	  ...
	  SELECT
		...
		CAST(COALESCE(NULLIF( _crmActivityNotes.notes , ''), NULLIF(crm_activity_type.default_note, '')) AS nvarchar (4000)),
