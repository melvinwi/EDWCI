...
CREATE VIEW [Views].[vRetentionValueOld]
...
theRating
       AS (SELECT DimCustomer.CustomerCode,
                  CASE
                  WHEN tenure.ActiveTenureInDays > 1460 THEN 4.0
                  WHEN tenure.ActiveTenureInDays > 1095 THEN  3.0
                  WHEN tenure.ActiveTenureInDays > 730 THEN  2.0
			   WHEN tenure.ActiveTenureInDays > 365 THEN  1.0
                      ELSE                                   0.0
                  END AS Tenure,

                  CASE
                  WHEN elecUsage.YearlyElecUsageKWH > 8000 THEN 4.0
                  WHEN elecUsage.YearlyElecUsageKWH > 6500 THEN  3.0
                  WHEN elecUsage.YearlyElecUsageKWH > 5500 THEN  2.0
                  WHEN elecUsage.YearlyElecUsageKWH > 4000 THEN  1.0
			   ...
			   WHEN gasUsage.YearlyGasUsageMJ > 35000 THEN    1.0
                      ELSE                                       0.0
                  END AS Usage,
                  ...
                  CASE
                  WHEN lossfactor.AverageLossFactor <= 1.07  THEN  4.0
                  WHEN lossfactor.AverageLossFactor <= 1.1235  THEN 3.0
                  WHEN lossfactor.AverageLossFactor >= 1.177 THEN  2.0
                      ELSE                                         1.0
                  END AS LossFactor,

                  CASE
                  WHEN pricePlanProfitability.ValueRatio >= 1.15 THEN   4.0
                  WHEN pricePlanProfitability.ValueRatio >= 1.08 THEN   3.0
                  WHEN pricePlanProfitability.ValueRatio >= 1.01 THEN  2.0
                      ELSE                                              1.0
			   ...
			   END AS Activities,
                  ...
                  CASE
                  WHEN paidOnTime.PaidOnTime12Months >= 0.75 THEN 4.0
                  WHEN paidOnTime.PaidOnTime12Months >= 0.50 THEN 3.0
	  ...
	  WHEN DimCustomer.OmbudsmanComplaints = 'Yes' THEN 'Bronze'
       WHEN ((theRating.Tenure * 0.10) + (theRating.Usage * 0.20) + (theRating.Debt * 0.20) + (theRating.PaymentMethod * 0.05) + (theRating.ActiveProducts * 0.05) + (theRating.LossFactor * 0.05) + (theRating.PricePlanProfitability * 0.25) + (theRating.Activities * 0.05) + (theRating.PaidOnTime * 0.05)) >= 3.01 THEN 'Platinum'
       WHEN ((theRating.Tenure * 0.10) + (theRating.Usage * 0.20) + (theRating.Debt * 0.20) + (theRating.PaymentMethod * 0.05) + (theRating.ActiveProducts * 0.05) + (theRating.LossFactor * 0.05) + (theRating.PricePlanProfitability * 0.25) + (theRating.Activities * 0.05) + (theRating.PaidOnTime * 0.05)) >= 2.01 THEN 'Gold'
       WHEN ((theRating.Tenure * 0.10) + (theRating.Usage * 0.20) + (theRating.Debt * 0.20) + (theRating.PaymentMethod * 0.05) + (theRating.ActiveProducts * 0.05) + (theRating.LossFactor * 0.05) + (theRating.PricePlanProfitability * 0.25) + (theRating.Activities * 0.05) + (theRating.PaidOnTime * 0.05)) >= 1.01 THEN 'Silver'
           ELSE 'Bronze'
       END AS Rating,
       theRating.PartyName,
	  ...
	  WHEN theRating.Tenure = 1.0 THEN 'Bronze'
           ELSE 'None'
       END AS Tenure,
       CASE
	  ...
	  WHEN theRating.Usage = 1.0 THEN 'Bronze'
           ELSE 'None'
       END AS Usage,
       CASE
