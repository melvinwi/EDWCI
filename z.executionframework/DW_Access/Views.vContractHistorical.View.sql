...
SELECT -- DimAccount
       ...
       -- DimContractDetails
       DimContractDetailsAll.ContractStatus,
       DimContractDetailsAll.ContractDetailedStatus,
        -- dimCustomer
       dimCustomer.LastName,
       -- FactContract
       ...
       DimContractDetailsAll.Meta_EffectiveStartDate,
       DimContractDetailsAll.Meta_EffectiveEndDate
...
LEFT   JOIN DW_Dimensional.DW.DimContractDetails ON DimContractDetails.ContractDetailsId = FactContract.ContractDetailsId
LEFT   JOIN DW_Dimensional.DW.DimContractDetails AS DimContractDetailsAll ON DimContractDetailsAll.ContractDetailsKey = DimContractDetails.ContractDetailsKey
