...
CREATE PROCEDURE [transform].[FactPricePlanRate_Usage_Gas]
...
BEGIN
    ...
    WITH applicablePricePlans
        AS (SELECT MAX (utl_pp_schedule.sched_id) AS sched_id,
              ...
              WHERE utl_pp_schedule.sched_type_id = 12
        ...
        CAST ( utl_pp_schedule_rate.invoice_desc AS nvarchar (100)) 
          FROM
               ...
               ON _DimPricePlan.PricePlanKey = N'USAGE.' + CAST ( utl_pp_schedule.price_plan_id AS nvarchar(10)) + N'.G'
