...
CREATE PROCEDURE [transform].[FactDailyPricePlan]
...
BEGIN
    ...
    --/
	   ...
	   WITH pricePlan
        ...
        INSERT INTO temp.FactDailyPricePlan (
	   ...
	   utl_account_price_plan.acnt_price_plan_id
          FROM DW_Staging.orion.utl_account_price_plan
              ...
              AND _DimProduct.Meta_IsCurrent = 1
               ...
               ON _DimPricePlan.PricePlanKey = N'DAILY.' + CAST(utl_account_price_plan.price_plan_id AS nvarchar(20))
          ...
          WHERE utl_account_price_plan.Meta_LatestUpdate_TaskExecutionInstanceId > @LatestSuccessfulTaskExecutionInstanceID
