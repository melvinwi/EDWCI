...
CREATE TABLE [config].[Task](
	...
	[FailureActionCode] [nchar](1) NOT NULL CONSTRAINT [DF_Task_FailureActionCode]  DEFAULT (N'C'),
	[RecoveryActionCode] [nchar](1) NOT NULL CONSTRAINT [DF_Task_RecoveryActionCode]  DEFAULT (N'N'),
