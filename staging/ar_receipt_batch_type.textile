...
h2. ARTEFACT: ar_receipt_batch_type

DESCRIPTION: Accounts Receivable batch type reference table from Orion
...
|seq_rcpt_batch_type_id 	|seq_rcpt_batch_type_id 	|numeric	|"18, 0"	|	|TRUE	|TRUE	|FALSE	|
|rcpt_batch_type_code 	|rcpt_batch_type_code 	|varchar	|10	|	|FALSE	|FALSE	|FALSE	|
|rcpt_batch_type_desc 	|rcpt_batch_type_desc 	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
...
|req_bank_ac_flag 	|req_bank_ac_flag 	|char	|1	|	|FALSE	|FALSE	|FALSE	|
|req_credit_card_flag 	|req_credit_card_flag 	|char	|1	|	|FALSE	|FALSE	|FALSE|
