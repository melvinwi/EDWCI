...
h2. ARTEFACT: utl_meter_class

DESCRIPTION: Meter Class reference table from Orion
...
|meter_class_code	|meter_class_code	|varchar	|10	|	|FALSE	|FALSE	|FALSE	|
|meter_class_desc	|meter_class_desc	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
|active	|active	|char	|10	|	|FALSE	|FALSE	|FALSE	|
...
|uom_id	|uom_id	|numeric	|"18,0"	|	|FALSE	|FALSE	|FALSE	|
