...
h2. ARTEFACT: utl_network_region

DESCRIPTION: Network Region reference table from Orion

|*COLUMN*	|*DESC*	|*TYPE*	|*LENGTH*	|*DEFAULT*	|*NOT_NULL*	|*PK*	|*AUTO_INCREMENT*	|
|region_id	|region_id	|numeric	|"18, 0"	|	|FALSE	|TRUE	|FALSE	|
|factor_measurement_id	|factor_measurement_id	|numeric	|"18, 0"	|	|FALSE	|FALSE	|FALSE	|
|region_code	|region_code	|varchar	|10	|	|FALSE	|FALSE	|FALSE	|
|region_desc	|region_desc	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
