...
h2. ARTEFACT: nc_involvement_type

DESCRIPTION: nc_involvement_type table from Orion
...
|seq_involve_type_id	|seq_involve_type_id	|numeric	|"18,0"	|	|TRUE	|TRUE	|FALSE
	|
|involve_type	|involve_type	|varchar	|10	|	|FALSE	|FALSE	|FALSE
	|
|involve_type_desc	|involve_type_desc	|varchar	|100	|	|FALSE	|FALSE	|FALSE
	|
