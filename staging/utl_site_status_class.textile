...
h2. ARTEFACT: utl_site_status_class

DESCRIPTION: Site Status Class reference table from Orion

|*COLUMN*	|*DESC*	|*TYPE*	|*LENGTH*	|*DEFAULT*	|*NOT_NULL*	|*PK*	|*AUTO_INCREMENT*	|
|site_status_class_id 	|site_status_class_id 	|numeric	|"18, 0"	|	|FALSE	|TRUE	|FALSE	|
|site_status_class_code 	|site_status_class_code 	|varchar	|20	|	|FALSE	|FALSE	|FALSE	|
|site_status_class_desc 	|site_status_class_desc 	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
