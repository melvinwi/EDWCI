...
h2. ARTEFACT: nc_inv_deliver_mode

DESCRIPTION: Invoice Delivery Mode table from Orion
...
|inv_del_mode_code	|inv_del_mode_code	|varchar	|10	|	|FALSE	|FALSE	|FALSE	|
|inv_del_mode_desc	|inv_del_mode_desc	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
...
|del_meth_id	|del_meth_id	|numeric	|"18,0"	|	|FALSE	|FALSE	|FALSE	|
|oss_desc	|oss_desc	|varchar	|1000	|	|FALSE	|FALSE	|FALSE	|
|oss_text	|oss_text	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
|category_code	|category_code	|varchar	|20	|	|FALSE	|FALSE	|FALSE|
