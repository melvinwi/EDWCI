...
h2. ARTEFACT: utl_virtual_meter_type

DESCRIPTION: Virtual meter reference table from Orion
...
|virtual_meter_type_id 	|virtual_meter_type_id 	|numeric	|"18, 0"	|	|FALSE	|TRUE	|FALSE	|
|virtual_meter_type_code 	|virtual_meter_type_code 	|varchar	|20	|	|FALSE	|FALSE	|FALSE	|
|virtual_meter_type_desc 	|virtual_meter_type_desc 	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
|gen_req_cons 	|gen_req_cons 	|varchar	|1	|	|FALSE	|FALSE	|FALSE	|
...
|sched_type_code 	|sched_type_code 	|varchar	|20	|	|FALSE	|FALSE	|FALSE	|
|autogen_vmr 	|autogen_vmr 	|varchar	|20	|	|FALSE	|FALSE	|FALSE|
