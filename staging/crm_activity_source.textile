...
h2. ARTEFACT: crm_activity_source

DESCRIPTION: Activity Source reference table from Orion

|*COLUMN*	|*DESC*	|*TYPE*	|*LENGTH*	|*DEFAULT*	|*NOT_NULL*	|*PK*	|*AUTO_INCREMENT
*	|
|seq_act_source_id	|seq_act_source_id	|numeric	|"18,0"	|	|TRUE	|TRUE	|FALSE
	|
|seq_act_class_id	|seq_act_class_id	|numeric	|"18,0"	|	|FALSE	|FALSE	|FALSE
	|
|act_source_code	|act_source_code	|varchar	|"20"	|	|FALSE	|FALSE	|FALSE
	|
|act_source_desc	|act_source_desc	|varchar	|"100"	|	|FALSE	|FALSE	|FALSE
	|
