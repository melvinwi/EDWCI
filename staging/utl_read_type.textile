...
h2. ARTEFACT: utl_read_type

DESCRIPTION: Read Type reference table from Orion

|*COLUMN*	|*DESC*	|*TYPE*	|*LENGTH*	|*DEFAULT*	|*NOT_NULL*	|*PK*	|*AUTO_INCREMENT*	|
|read_type_id 	|read_type_id 	|numeric	|"18, 0"	|	|FALSE	|FALSE	|FALSE	|
|read_type_code 	|read_type_code 	|varchar	|10	|	|FALSE	|FALSE	|FALSE	|
|read_type_desc 	|read_type_desc 	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
