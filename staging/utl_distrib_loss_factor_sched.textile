...
h2. ARTEFACT: utl_distrib_loss_factor_sched

DESCRIPTION: Loss Factor reference table from Orion
...
|dlf_sched_id 	|dlf_sched_id 	|numeric	|"18, 0"	|	|TRUE	|TRUE	|FALSE	|
|dlf_id 	|dlf_id 	|numeric	|"18, 0"	|	|FALSE	|FALSE	|FALSE	|
|dlf_factor 	|dlf_factor 	|numeric	|"18, 4"	|	|FALSE	|FALSE	|FALSE	|
