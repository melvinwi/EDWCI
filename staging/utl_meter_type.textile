...
h2. ARTEFACT: utl_meter_type

DESCRIPTION: Meter Type reference table from Orion

|*COLUMN*	|*DESC*	|*TYPE*	|*LENGTH*	|*DEFAULT*	|*NOT_NULL*	|*PK*	|*AUTO_INCREMENT*	|
|meter_type_id	|meter_type_id	|numeric	|"18,0"	|	|FALSE	|FALSE	|FALSE	|
|meter_class_id	|meter_class_id	|numeric	|"18,0"	|	|FALSE	|FALSE	|FALSE	|
|meter_type_code	|meter_type_code	|varchar	|10	|	|FALSE	|FALSE	|FALSE	|
|meter_type_desc	|meter_type_desc	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
...
|cost_price_class_id	|cost_price_class_id	|numeric	|"18, 0"	|	|FALSE	|FALSE	|FALSE	|
|public_holidays	|public_holidays	|varchar	|1	|	|FALSE	|FALSE	|FALSE	|
