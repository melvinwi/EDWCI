...
h2. ARTEFACT: utl_accnt_meter_price_plan

DESCRIPTION: Relationship table from Orion

|*COLUMN*	|*DESC*	|*TYPE*	|*LENGTH*	|*DEFAULT*	|*NOT_NULL*	|*PK*	|*AUTO_INCREMENT*	|
|accnt_meter_price_plan_id 	|accnt_meter_price_plan_id 	|numeric	|"18, 0"	|	|FALSE	|TRUE	|FALSE	|
|seq_product_item_id 	|seq_product_item_id 	|numeric	|"18, 0"	|	|FALSE	|FALSE	|FALSE	|
|meter_id 	|meter_id 	|numeric	|"18, 0"	|	|FALSE	|FALSE	|FALSE	|
|meter_pp_type_id 	|meter_pp_type_id 	|numeric	|"18, 0"	|	|FALSE	|FALSE	|FALSE	|
...
|pp_cost_simple_sched_id 	|pp_cost_simple_sched_id 	|numeric	|"18, 0"	|	|FALSE	|FALSE	|FALSE	|
