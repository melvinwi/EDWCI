...
h2. ARTEFACT: nem_change_reason

DESCRIPTION: Market Change Reason reference table from Orion
...
|change_reason_id 	|change_reason_id 	|numeric	|"18, 0"	|	|TRUE	|TRUE	|FALSE	|
|change_reason_code 	|change_reason_code 	|varchar	|10	|	|FALSE	|FALSE	|FALSE	|
|change_reason_desc 	|change_reason_desc 	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
|switch_reason_flag 	|switch_reason_flag 	|char	|1	|	|FALSE	|FALSE	|FALSE	|
...
|end_date_required 	|end_date_required 	|varchar	|1	|	|FALSE	|FALSE	|FALSE	|
|bus_days_in_past 	|bus_days_in_past 	|int	|	|	|FALSE	|FALSE	|FALSE	|
|bus_days_in_future 	|bus_days_in_future 	|int	|	|	|FALSE	|FALSE	|FALSE	|
...
|retro_cr_code 	|retro_cr_code 	|varchar	|10	|	|FALSE	|FALSE	|FALSE	|
|future_cr_code 	|future_cr_code 	|varchar	|10	|	|FALSE	|FALSE	|FALSE|
