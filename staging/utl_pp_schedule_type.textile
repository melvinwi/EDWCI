...
h2. ARTEFACT: utl_pp_schedule_type

DESCRIPTION: Schedule Type reference table from Orion
...
|sched_type_id 	|sched_type_id 	|numeric	|"18, 0"	|	|TRUE	|TRUE	|FALSE	|
|sched_class_id 	|sched_class_id 	|numeric	|"18, 0"	|	|FALSE	|FALSE	|FALSE	|
|seq_product_type_id 	|seq_product_type_id 	|numeric	|"18, 0"	|	|FALSE	|FALSE	|FALSE	|
|sched_type_code 	|sched_type_code 	|varchar	|10	|	|FALSE	|FALSE	|FALSE	|
|sched_type_desc 	|sched_type_desc 	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
...
|use_simple_schedule 	|use_simple_schedule 	|varchar	|1	|	|FALSE	|FALSE	|FALSE	|
|minimum_charge_freq 	|minimum_charge_freq 	|varchar	|20	|	|FALSE	|FALSE	|FALSE|
