...
h2. ARTEFACT: utl_unit_of_measure

DESCRIPTION: Unit of Measurement reference table from Orion
...
|uom_id 	|uom_id 	|numeric	|"18, 0"	|	|TRUE	|TRUE	|FALSE	|
|uom_code 	|uom_code 	|varchar	|10	|	|FALSE	|FALSE	|FALSE	|
|uom_desc 	|uom_desc 	|varchar	|100	|	|FALSE	|FALSE	|FALSE	|
