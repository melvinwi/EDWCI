...
h2. ARTEFACT: utl_site_class

DESCRIPTION: Site Class table from Orion

|*COLUMN*	|*DESC*	|*TYPE*	|*LENGTH*	|*DEFAULT*	|*NOT_NULL*	|*PK*	|*AUTO_INCREMENT
*	|
|site_class_id	|site_class_id	|numeric	|"18,0"	|	|FALSE	|FALSE	|FALSE
	|
|site_class_code	|site_class_code	|varchar	|10	|	|FALSE	|FALSE	|FALSE
	|
|site_class_desc	|site_class_desc	|varchar	|100	|	|FALSE	|FALSE	|FALSE
	|
