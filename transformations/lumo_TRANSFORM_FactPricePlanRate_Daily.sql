CREATE PROCEDURE lumo.TRANSFORM_FactPricePlanRate_Daily
...
--/
	...
	;WITH applicablePricePlans AS (SELECT MAX (utl_pp_schedule.sched_id) AS sched_id, utl_pp_schedule.price_plan_id FROM /* Staging */ lumo.utl_pp_schedule WHERE utl_pp_schedule.sched_type_id = 5 OR utl_pp_schedule.sched_type_id = 11 GROUP BY utl_pp_schedule.price_plan_id)
