...
BEGIN
	...
	INSERT INTO lumo.DimAccount (
	  ...
	  FROM lumo.crm_party, lumo.nc_client, accountStatus AS _accountStatus WHERE nc_client.seq_party_id = crm_party.seq_party_id AND _accountStatus.seq_party_id = nc_client.seq_party_id AND (crm_party.Meta_ChangeFlag = 1 OR nc_client.Meta_ChangeFlag = 1 OR _accountStatus.Meta_ChangeFlag = 1) ;
END;