...
h2. ARTEFACT: TRANSFORM_DimPricePlan_Usage_Gas
...
|N'USAGE.' + CAST(	|"utl_price_plan":../staging/utl_price_plan.textile .price_plan_id	| AS nvarchar(10)) + N'.G'	|"DimPricePlan":../datastore/DimPricePlan.textile .PricePlanKey	|One to one mapping	|
|	|"utl_price_plan":../staging/utl_price_plan.textile .price_plan_code	|+ N'.G'	|"DimPricePlan":../datastore/DimPricePlan.textile .PricePlanCode	|One to one mapping	|
...
|/*	|"utl_price_plan":../staging/utl_price_plan.textile .price_plan_id	|*/ N'Usage'	|"DimPricePlan":../datastore/DimPricePlan.textile .PricePlanType	|Hardcoded	|
