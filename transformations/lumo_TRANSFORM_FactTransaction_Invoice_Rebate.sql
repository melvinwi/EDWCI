...
--/
	...
	INSERT INTO lumo.FactTransaction (
	  ...
	  SELECT
		...
		/* utl_transaction.trans_id */ N'REB' + CAST(utl_transaction.trans_id AS NVARCHAR(11)) + N'.' + CAST(utl_transaction.trans_seq AS NVARCHAR(2)),
		/* utl_transaction.trans_id */ -1,
