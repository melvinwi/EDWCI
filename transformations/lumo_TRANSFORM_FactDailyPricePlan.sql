CREATE PROCEDURE lumo.TRANSFORM_FactDailyPricePlan
...
--/
	...
	INSERT INTO lumo.FactDailyPricePlan (
		FactDailyPricePlan.AccountId,
		FactDailyPricePlan.ServiceId,
		FactDailyPricePlan.ProductId,
		...
		FactDailyPricePlan.DailyPricePlanKey)
	  SELECT
