...
function test_generate_doc(artefactName, schema, design, sourceTables, destinationTable) // Constructor
{
    sourceTables = sourceTables.toString();
    destinationTable = destinationTable.toString();
