...
|SELECTION_CRITERIA	|FROM [schema]."utl_site":../staging/utl_site.textile  WHERE "utl_site":../staging/utl_site.textile .Meta_LatestUpdate_TaskExecutionInstanceId  > @LatestSuccessfulTaskExecutionInstanceID|
