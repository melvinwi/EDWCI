CREATE PROCEDURE lumo.TRANSFORM_DimMeterRegister
...
--/
	...
	INSERT INTO lumo.DimMeterRegister (
	  ...
	  SELECT
		...
		CAST(CASE utl_meter_class.seq_product_type_id WHEN '1' THEN 'Internet' WHEN '2' THEN 'Electricity' WHEN '3' THEN 'Gas' WHEN '7' THEN 'Telco' ELSE NULL END AS nvarchar(11)),
