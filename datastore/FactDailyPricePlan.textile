...
h2. ARTEFACT: FactDailyPricePlan

DESCRIPTION: Daily Price Plan relationship fact table
...
|DailyPricePlanStartDateId	|Daily Price Plan Start Date	|int	|	|99991231	|TRUE	|	|FALSE	|
|DailyPricePlanEndDateId	|Daily Price Plan End Date	|int	|	|99991231	|TRUE	|	|FALSE	|
|DailyPricePlanKey	|Daily Price Plan relationship ID from the source system	|int	|	|-1	|TRUE	|	|FALSE|
